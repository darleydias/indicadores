function conquistados(ano,mes){
    var URI="";

    URI="http://192.168.0.11:8000/api/omie/oportunidade/cliente-conquistado";
           ...
           // PEGO O MAIOR PARA
            ...
            for(var i=0;i<5;i++) {
                ...
                if(document.getElementById(parseInt(i+1)+'_'+ano+'_'+mes)!=null){         
                   ...
                   var labelQuant = document.getElementById(parseInt(i+1)+'_'+ano+'_'+mes).innerHTML=result[i].regSemana;
                   let cor = 0;
